...
# Paths
model_path = r'C:\Users\zachp\OneDrive - University of Leicester\Computer science project\resnet50_3_class_modelCovid.h5'
...
target_paths = {
    ...
    'Covid': r'C:\Users\zachp\OneDrive - University of Leicester\Computer science project\Covid',
    'Pneumonia': r'C:\Users\zachp\OneDrive - University of Leicester\Computer science project\Bacterial'
}
...
for img_name in os.listdir(data_path):
    ...
    if img_name.lower().endswith(('.png', '.jpg', '.jpeg')):  # Check if the file is an image
        ...
        if predicted_class == 0:
            shutil.move(img_path, target_paths['Covid'])
        elif predicted_class == 1:
            shutil.move(img_path, target_paths['Normal'])
        elif predicted_class == 2:
            shutil.move(img_path, target_paths['Pneumonia'])